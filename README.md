...
Установим Python-библиотеку MegaDetector (может занять некоторое время в зависимости от скорости скачивания, у меня при средней скорости 125 kB/s потребовалось около 30 минут):
```bash
